...
// atributos: edad, sexo, estatura y nombre
	...
	public static void main(String... args){
		...
		int edadPersona = personaJorge.obtenerEdad(1995,2022);
		System.out.println("La edad de Jorge es: " + edadPersona);
            //referenciar instancia dos
            Persona personaJuan = new Persona();
            int edadPersonaJuan = personaJuan.obtenerEdad(1985,2022);
            System.out.println("La edad de la persona dos es: " + edadPersonaJuan);
	}
